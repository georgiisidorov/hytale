...
public class TurnOffTeleportersSystem extends RefSystem<ChunkStore> {
    ...
    public void onEntityAdded(
        ...
        // Avoid re-entrant chunk loads while the store is still processing chunk LOAD.
    }
    ...
    public static void updatePortalBlocksInWorld(World world) {
        ...
        store.forEachChunk(QUERY, TurnOffTeleportersSystem::updatePortalBlocksInChunk);
    }
