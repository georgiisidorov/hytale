...
export const HowToConnectPage = () => {
    ...
    useEffect(() => {
        fetch('https://updates.m4hytal.ru/update/windows/1.0.0')
            .then((res) => res.json())
        ...
        <Container wide className="pb-[120px] pt-[140px] desktop:pt-[170px]">
            ...
            <div className="mt-11 flex flex-col gap-10">
                ...
                <div>
                    ...
                    <p className="mt-3 font-outfit text-[21px] font-light leading-[1.3] text-[#c9c9c9]">
                        Сервер уже встроен в лаунчер — ничего добавлять, настраивать или вводить
                        вручную не нужно. Просто нажмите «Играть» и отправляйтесь в мир Hytale.
                    </p>
                </div>
            </div>
